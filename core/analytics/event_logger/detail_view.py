...
class EventLoggerAnalyticsDetailView(APIView):
    """
    Class responsible for EventLoggerAnalytics CRUD operations
    """
    ...
    def get_object(self, event_id):
        ...
        """
        return get_object_or_404(EventLoggerAnalytics, pk=event_id)
